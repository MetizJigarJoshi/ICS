/*
  ...
  1. New Tables
    ...
    - `eligibility_submissions`
      ...
      - `personal_info` (jsonb, stores personal details)
      - `education_info` (jsonb, stores education details)
      - `work_experience` (jsonb, stores work experience)
      - `language_skills` (jsonb, stores language test scores)
      - `canadian_connections` (jsonb, stores family/work connections)
      - `additional_info` (jsonb, stores other relevant information)
  ...
  2. Security
    ...
    - Add policies for reading user profiles and submissions

  3. Functions
    - Trigger to automatically create user profile on auth signup
    - Function to generate unique reference IDs for submissions
*/
